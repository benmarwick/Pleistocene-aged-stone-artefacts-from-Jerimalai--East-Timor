# Updated to leave only the functions useful for plotting
# as internals for the package
# Ben Marwick, April 2015S
...
diagMCMC = function( codaObject , parName=coda::varnames(codaObject)[1] ,
