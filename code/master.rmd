...
# get transverse and longitude breaks
...
Correlation of maximum core dimension with mass

```{r lithics_core_max_dim}
...
Flake scars on cores

```{r lithics_core_flake_scars}
